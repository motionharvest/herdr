...
pub struct Keybinds {
    ...
    pub split_left: ActionKeybinds,
    pub split_down: ActionKeybinds,
    pub split_up: ActionKeybinds,
    pub split_right: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            split_left: action!("keys.split_left", &self.keys.split_left),
            split_down: action!("keys.split_down", &self.keys.split_down),
            split_up: action!("keys.split_up", &self.keys.split_up),
            split_right: action!("keys.split_right", &self.keys.split_right),
