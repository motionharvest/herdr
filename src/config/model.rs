...
pub struct KeysConfig {
    ...
    /// Detach from server/client mode, or exit --no-session mode. Default: "ctrl+q".
    ...
    /// Focus the pane to the left. Default: "ctrl+left".
    pub focus_pane_left: BindingConfig,
    /// Focus the pane below. Default: "ctrl+down".
    pub focus_pane_down: BindingConfig,
    /// Focus the pane above. Default: "ctrl+up".
    pub focus_pane_up: BindingConfig,
    /// Focus the pane to the right. Default: "ctrl+right".
    ...
    /// Add a new pane to the left of the focused pane. Default: "ctrl+alt+left"
    pub split_left: BindingConfig,
    /// Add a new pane below the focused pane. Default: "ctrl+alt+down"
    pub split_down: BindingConfig,
    /// Add a new pane above the focused pane. Default: "ctrl+alt+up"
    pub split_up: BindingConfig,
    /// Add a new pane to the right of the focused pane. Default: "ctrl+alt+right"
    pub split_right: BindingConfig,
    /// Close the focused pane. Default: "prefix+x" and "ctrl+w"
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            focus_pane_left: BindingConfig::one("ctrl+left"),
            focus_pane_down: BindingConfig::one("ctrl+down"),
            focus_pane_up: BindingConfig::one("ctrl+up"),
            focus_pane_right: BindingConfig::one("ctrl+right"),
            ...
            split_left: BindingConfig::one("ctrl+alt+left"),
            split_down: BindingConfig::one("ctrl+alt+down"),
            split_up: BindingConfig::one("ctrl+alt+up"),
            split_right: BindingConfig::one("ctrl+alt+right"),
...
"#;
    ...
    fn nerd_font_default_off_and_parses() {
        let default_config = Config::default();
        assert!(!default_config.ui.nerd_font);
...
"#;
    ...
    #[test]
    fn directional_split_keybinds_default_to_ctrl_alt_arrows() {
        let default_config = Config::default();

        assert_eq!(
            default_config.keys.split_left,
            BindingConfig::one("ctrl+alt+left")
        );
        assert_eq!(
            default_config.keys.split_down,
            BindingConfig::one("ctrl+alt+down")
        );
        assert_eq!(
            default_config.keys.split_up,
            BindingConfig::one("ctrl+alt+up")
        );
        assert_eq!(
            default_config.keys.split_right,
            BindingConfig::one("ctrl+alt+right")
        );
    }

    #[test]
    fn pane_focus_keybinds_default_to_ctrl_arrows() {
        let default_config = Config::default();

        assert_eq!(
            default_config.keys.focus_pane_left,
            BindingConfig::one("ctrl+left")
        );
        assert_eq!(
            default_config.keys.focus_pane_down,
            BindingConfig::one("ctrl+down")
        );
        assert_eq!(
            default_config.keys.focus_pane_up,
            BindingConfig::one("ctrl+up")
        );
        assert_eq!(
            default_config.keys.focus_pane_right,
            BindingConfig::one("ctrl+right")
        );
    }
