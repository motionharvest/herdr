...
[theme]
# Built-in themes: catppuccin, terminal, tokyo-night, dracula, synthwave,
...
# split_left = "ctrl+alt+left"
# split_down = "ctrl+alt+down"
# split_up = "ctrl+alt+up"
# split_right = "ctrl+alt+right"
# close_pane = ["prefix+x", "ctrl+w"]
...
# Use Nerd Font glyphs in optional UI chrome.
# nerd_font = false
