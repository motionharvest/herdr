...
impl HeadlessServer {
    ...
    fn perform_live_handoff(
        ...
        let snapshot = crate::persist::capture(&self.app.state, &self.app.terminal_runtimes);
    ...
    fn handle_scheduled_tasks_headless(&mut self, now: Instant, geometry_dirty: bool) -> bool {
        ...
        if self.has_app_client() {
            ...
            changed |= self.app.poll_player_if_due(now);
        }
...
"#,
    ...
    async fn resize_shared_runtime_resizes_background_tabs() {
        ...
        let expected = (pane_info.inner_rect.height, pane_info.inner_rect.width);
        assert_eq!(
            server
                .app
                .state
