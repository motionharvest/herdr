...
Herdr is mouse-native. You can click panes, tabs, workspaces, and agents. You can drag split borders, drag a pane name over another space to drop it there, drag a pane or an agent onto `+ new` to fly it out, select text, and use right-click menus.
