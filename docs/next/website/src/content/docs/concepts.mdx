...
Herdr is mouse-native. You can click panes, tabs, workspaces, and agents. You can drag split borders, drag a pane name over another space to drop it there, select text, and use right-click menus.
