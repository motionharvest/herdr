...
- **drag a panel to the New workspace button** — drag a pane, or an agent from the table or sidebar, onto `+ new` in the sidebar to fly it out into its own workspace
